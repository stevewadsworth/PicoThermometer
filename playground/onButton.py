...
buttonA = Button(Pin(12, mode=Pin.IN, pull=Pin.PULL_UP))
buttonA.on_release(lambda x: print("Released A"))
buttonA.on_long_press(lambda x: print("Long pressed A")).on_press(lambda x: print("Pressed A chained"))

buttonB = Button(Pin(13, mode=Pin.IN, pull=Pin.PULL_UP), long_press_duration=1000).on_event(lambda event: print(event))
